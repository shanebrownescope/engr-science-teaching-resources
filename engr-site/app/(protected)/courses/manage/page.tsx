  ...
  const handleDelete = async (courseId: string, courseName: string) => {
    ...
    try {
      ...
      if (result.success) {
        ...
        const updatedCourses = courses.filter(course => String(course.id) !== courseId);
        setCourses(updatedCourses);
        
        // Clear edit mode if deleting the course being edited
        if (editingCourse && String(editingCourse.id) === courseId) {
          handleCancelEdit();
        }
                ...
                >
                  ...
                  <div className={styles.courseActions}>
                    ...
                    <button
                      ...
                      onClick={() => handleDelete(String(course.id), course.name)}
                      disabled={isSubmitting}
                    >
                      Delete
                    </button>
